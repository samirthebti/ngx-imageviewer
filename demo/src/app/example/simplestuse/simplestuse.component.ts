...
@Component({
  selector: 'app-simplest-use',
  templateUrl: './simplestuse.component.html',
  styleUrls: ['./simplestuse.component.scss']
})
export class SimplestUseComponent implements OnInit {
